...
export default function PostPropertyModal({
	...
	const subTypes = selectedPropertyType == 0 ? landTypes : buildingTypes;
			...
			<Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
				...
				<DialogContent>
					<form onSubmit={handleSubmit(handleFormSubmit)}>
						...
						<input type="file" accept="image/*" multiple {...register("ImageUrls")} onChange={handleImageUrlsChange} />
